...
class Reader:
  ...
  def get_tuples(self):
    ...
    with open(self.filename) as csvfile:
      ...
      for row in reader:
        tupled_row = tuple(row[attribute].lower().strip() for attribute in self.ATTRIBUTES)
